...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => DarwinsilalahiDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-Darwin Silalahi (6SIA5)'),
        ),
        body: LoginPage(),
      ),
    );
...
class DarwinsilalahiDataTable extends StatefulWidget {
  _DarwinSilalahiDataTableState createState() => _DarwinSilalahiDataTableState();
}

class _DarwinSilalahiDataTableState extends State <DarwinSilalahi DataTable> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Darwin Silalahi- 6SIA5'),
      ),
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Darwin Silalahi", ),
      DataMahasiswa(),
